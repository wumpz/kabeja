...
public class Constants {
  ...
  public static final String BLOCK_MODELSPACE = "*MODEL_SPACE";
  public static final String BLOCK_PAPERSPACE = "*PAPER_SPACE";

  public static final int COMMAND_CODE = 0;
  public static final LineType DEFAULT_LINETYPE = new LineType("CONTINUOUS");
  ...
  public static final int COLOR_VALUE_BY_LAYER = 256;
  ...
  public static final String ENTITY_TYPE_ATTDEF = "ATTDEF";
  ...
  public static final double POINT_CONNECTION_RADIUS = 0.0001;
  ...
  public static final String TABLES_END = "ENDTAB";
