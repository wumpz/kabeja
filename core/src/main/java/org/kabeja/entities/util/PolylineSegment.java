...
public class PolylineSegment {
  ...
  public PolylineSegment(Vertex start, Vertex end, Polyline p) {
    this.start = start;
  ...
  protected void createCurvedTrapezium(Vertex start, Vertex end, double radius, double length) {
    ...
    Point3D mp = MathUtils.getPointOfStraightLine(start.getPoint(), edgeDirection, s);
  ...
  protected void createTrapezium(Vertex start, Vertex end) {
