...
public class Utils {
  ...
  public static Point3D getPointFromParameterizedLine(
      Point3D basePoint, Vector direction, double parameter) {
  ...
  /**
   * Converts the default iterator to a sorted iterator by the z-index of layers
   *
   * @param i
   * @return
   */
  ...
  public static String generateNewID(DraftDocument doc) {
    ...
    Variable v = header.getVariable(Constants.HEADER_VARIABLE_HANDSEED);
