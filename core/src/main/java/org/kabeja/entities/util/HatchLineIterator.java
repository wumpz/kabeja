...
public class HatchLineIterator implements Iterator<HatchLineSegment> {
  ...
  public HatchLineIterator(Hatch hatch, HatchLineFamily pattern) {
    ...
    // edge 0
    Point3D start = new Point3D(this.hatchBounds.getMinimumX(), this.hatchBounds.getMaximumY(), 0);
    Point3D end = new Point3D(this.hatchBounds.getMinimumX(), this.hatchBounds.getMinimumY(), 0);
    this.boundaryEdges.add(new ParametricLine(start, MathUtils.getVector(start, end)));

    // edge 1
    start = new Point3D(this.hatchBounds.getMinimumX(), this.hatchBounds.getMinimumY(), 0);
    end = new Point3D(this.hatchBounds.getMaximumX(), this.hatchBounds.getMinimumY(), 0);
    this.boundaryEdges.add(new ParametricLine(start, MathUtils.getVector(start, end)));

    // edge 2
    start = new Point3D(this.hatchBounds.getMaximumX(), this.hatchBounds.getMinimumY(), 0);
    end = new Point3D(this.hatchBounds.getMaximumX(), this.hatchBounds.getMaximumY(), 0);
    this.boundaryEdges.add(new ParametricLine(start, MathUtils.getVector(start, end)));

    // edge 3
    start = new Point3D(this.hatchBounds.getMaximumX(), this.hatchBounds.getMaximumY(), 0);
    end = new Point3D(this.hatchBounds.getMinimumX(), this.hatchBounds.getMaximumY(), 0);
    this.boundaryEdges.add(new ParametricLine(start, MathUtils.getVector(start, end)));
