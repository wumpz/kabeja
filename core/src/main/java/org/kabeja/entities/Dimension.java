...
public class Dimension extends Entity {
   ...
   *
   * <p>This entity partially operates with OCS-coordinates, therefore this method should be
   * implemented, otherwise OCS-coordinates will be used regardless of calling this method.
   */
  @Override
  public void toWcs() {
