...
public class ColorTable {
  ...
  public String getRGBString(int dxfColorCode) {
    ...
    return String.format(
        "rgb(%d,%d,%d)", rgbs[dxfColorCode][0], rgbs[dxfColorCode][1], rgbs[dxfColorCode][2]);
  }
  ...
  public String getRGBHexString(int dxfColorCode) {
    ...
    return String.format(
        "%02x%02x%02x", rgbs[dxfColorCode][0], rgbs[dxfColorCode][1], rgbs[dxfColorCode][2]);
  }
