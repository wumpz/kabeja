...
public class DraftDocument {
   ...
   *
   * @param name of the {
   * @see org.kabeja.common.LineType}
   * @return
   */
   ...
   * Get the {
   *
   * @see java.util.Collection} of all containing {
   * @see org.kabeja.common.LineType}
   * @return the {
   * @see java.util.Collection} of {
   * @see org.kabeja.common.LineType}
   */
  ...
  /**
   * Adds the given to the DraftDocument. It will placed on the layer of the entity if this one
   * exists otherwise the entity will be added to the RootLayer "0".
   *
   * @param entity {
   * @see org.kabeja.common.DraftEntity}
   */
  ...
  /**
   * Add a block to the DraftDocument, all entities of the block get this DraftDocument as
   * OwnerDocument
   *
   * @param block
   */
   ...
   * Returns the {
   *
   * @see org.kabeja.math.Bounds} of this document
   * @return
   */
  ...
  /**
   * Returns the bounds of this document by distinguished model space or paper space
   *
   * @return
   */
   ...
   *
   * @return {
   * @see java.util.Collection} of all HatchPattern of this document
   */
