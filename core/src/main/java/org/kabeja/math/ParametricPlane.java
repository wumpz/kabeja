...
public class ParametricPlane {
   ...
   */
  public ParametricPlane(Point3D basePoint, Vector directionX, Vector directionY, Vector normal) {
    this.base = basePoint;
  ...
  public ParametricPlane(Extrusion e) {
    this(new Point3D(0.0, 0.0, 0.0), e.getDirectionX(), e.getDirectionY(), e.getNormal());
  }
