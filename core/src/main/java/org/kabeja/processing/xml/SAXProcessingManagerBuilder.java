  ...
  public void startElement(String namespaceURI, String localName, String qName, Attributes atts)
    ...
    if (namespaceURI.equals(XMLNS_KABEJA_PROCESSING)) {
      if (ELEMENT_SAXFILTER.equals(localName) && this.config) {
        ...
        this.properties = new HashMap<>();
        this.xmlPipeline.setSAXSerializer(
            this.manager.getSAXSerializer(atts.getValue(ATTRIBUTE_NAME)));
        ...
        this.xmlPipeline.setSAXGenerator(
            this.manager.getSAXGenerator(atts.getValue(ATTRIBUTE_NAME)));
