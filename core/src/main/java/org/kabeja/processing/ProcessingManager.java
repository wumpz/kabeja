...
public class ProcessingManager {
  ...
  public void process(
      DraftDocument doc, Map<String, Object> context, String pipeline, OutputStream out)
      throws ProcessorException {
  ...
  public void process(
      DraftDocument doc, Map<String, Object> context, String pipeline, String sourceFile)
      throws ProcessorException {
    if (this.pipelines.containsKey(pipeline)) {
      try {
        ProcessPipeline pp = (ProcessPipeline) this.pipelines.get(pipeline);
