...
public class DraftFileTransferHandler extends TransferHandler {
  private ProcessingRunViewComponent c;

  public DraftFileTransferHandler(ProcessingRunViewComponent c) {
    this.c = c;
  }
  ...
  public boolean importData(JComponent c, Transferable t) {
    ...
    if (files.size() > 0) {
      ...
      // TODO change to handle all registrated
      // parsers
