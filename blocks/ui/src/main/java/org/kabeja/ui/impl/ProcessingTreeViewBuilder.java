...
public class ProcessingTreeViewBuilder {
  ...
  public javax.swing.JComponent getView() {
    ...
    JPanel panel =
        PanelFactory.createTitledPanel(scroll, "ProcessingTree", "Options", createBorderMenu());
  ...
  private JPopupMenu createBorderMenu() {
    ...
    JMenuItem item =
        new JMenuItem(
            "Expand All",
            new ImageIcon(UIUtils.resourceToBytes(this.getClass(), "/icons/expand_all.gif")));
    item.setMnemonic('E');
    ...
    item =
        new JMenuItem(
            "Collapse All",
            new ImageIcon(UIUtils.resourceToBytes(this.getClass(), "/icons/collapse_all.gif")));
    item.setMnemonic('C');
    item.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
