...
public class ProcessingUI
  ...
  protected void initialize() {
    ...
    menu.add(
        new AbstractAction(Messages.getString("ProcessingUI.menu.file.exit")) {
  ...
  public void addViewComponent(ViewComponent component) {
    ...
    if (mainPanel.getMinimumSize().getWidth() < view.getPreferredSize().getWidth()) {
  ...
  public void setServiceManager(ServiceManager manager) {
    ...
    org.kabeja.tools.Component[] objects =
        this.serviceManager.getServiceComponents(Application.SERVICE);
