 ...
 * @author simon
 */
public class DraftSAXDocumentFactory extends SAXDocumentFactory {
  public DraftSAXDocumentFactory() {
    super(SVGDOMImplementation.getDOMImplementation(), null);
  }

  public SVGDocument createDocument(org.kabeja.DraftDocument doc, Map properties)
      throws SAXException {
