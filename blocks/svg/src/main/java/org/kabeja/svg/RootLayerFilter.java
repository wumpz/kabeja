...
public class RootLayerFilter extends AbstractSAXFilter {
  ...
  public void endElement(String uri, String localName, String qName) throws SAXException {
    if (this.inDraftSection) {
      if (uri.equals(SVGConstants.SVG_NAMESPACE) && localName.equals(SVGConstants.SVG_GROUP)) {
      ...
      if (((id != null) && id.equals("draft")) || this.inDraftSection) {
        ...
        switch (groupDepth) {
          ...
          case 1:
            ...
            if (attributes.getIndex(SVGConstants.SVG_ATTRIBUTE_TRANSFORM) != -1) {
              attributes.setAttribute(
                  attributes.getIndex(SVGConstants.SVG_ATTRIBUTE_TRANSFORM),
                  "",
            ...
            if (attributes.getIndex(SVGConstants.SVG_ATTRIBUTE_STROKE_WITDH) == -1) {
              attributes.addAttribute(
                  "",
