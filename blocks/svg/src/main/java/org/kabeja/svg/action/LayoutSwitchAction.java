  ...
  public JComponent getView() {
    if (this.button == null) {
      ...
      JCheckBoxMenuItem item =
          new JCheckBoxMenuItem(SVGGenerator.PROPERTY_DOCUMENT_BOUNDS_RULE_MODELSPACE_VALUE);
      ...
      item =
          new JCheckBoxMenuItem(SVGGenerator.PROPERTY_DOCUMENT_BOUNDS_RULE_MODELSPACE_LIMITS_VALUE);
      //            item.addItemListener(l);
      //            item.setIcon(new ImageIcon(UIUtils.resourceToBytes(
      ...
      menu.add(item);
      item =
          new JCheckBoxMenuItem(SVGGenerator.PROPERTY_DOCUMENT_BOUNDS_RULE_PAPERSPACE_LIMITS_VALUE);
      item.addItemListener(l);
      //            item.setIcon(new ImageIcon(UIUtils.resourceToBytes(
