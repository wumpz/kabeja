...
public class SVGLWPolylineGenerator extends AbstractSVGSAXGenerator
  ...
  protected String getVertexPath(LW2DVertex start, LW2DVertex end, LWPolyline pline) {
    StringBuffer d = new StringBuffer();
  ...
  protected void polylinePartToSAX(ContentHandler handler, Map svgContext, LWPolyline pline)
      throws SAXException {
    // output as group
    AttributesImpl attr = new AttributesImpl();
