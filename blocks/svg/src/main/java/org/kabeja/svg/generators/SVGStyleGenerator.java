...
public class SVGStyleGenerator {
   ...
   */
  public static void toSAX(ContentHandler handler, Map svgContext, Style style)
      throws SAXException {
  ...
  protected static void generateSAXFontDescription(ContentHandler handler, String font)
    ...
    attr.addAttribute("", "", "xmlns:xlink", "CDATA", SVGConstants.XLINK_NAMESPACE);
    attr.addAttribute(SVGConstants.XLINK_NAMESPACE, "href", "xlink:href", "CDATA", url);
