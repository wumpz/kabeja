...
public class SVGPolylineGenerator extends AbstractSVGSAXGenerator
  ...
  protected void polylineToSAX(ContentHandler handler, Map svgContext, Polyline pline)
      throws SAXException {
  ...
  protected void polylinePartToSAX(ContentHandler handler, Map svgContext, Polyline pline)
      throws SAXException {
    // output as group
    AttributesImpl attr = new AttributesImpl();
    super.setCommonAttributes(attr, svgContext, pline);
  ...
  protected void splineFitToSAX(ContentHandler handler, Map svgContext, Polyline pline)
      throws SAXException {
  ...
  protected void singleEdgeToSAX(
      ContentHandler handler, Vertex start, Vertex end, Map svgContext, Polyline pline)
      throws SAXException {
    AttributesImpl attr = new AttributesImpl();
    super.setCommonAttributes(attr, svgContext, pline);
    ...
    if (start.getStartWidth() > 0.0) {
      SVGUtils.addAttribute(
          attr, SVGConstants.SVG_ATTRIBUTE_STROKE_WITDH, "" + start.getStartWidth());
    }

    SVGUtils.emptyElement(handler, SVGConstants.SVG_PATH, attr);
  }

  protected void polyfaceToSAX(ContentHandler handler, Map svgContext, Polyline pline)
      throws SAXException {
  ...
  protected void addEdgeToPath(Vertex start, Vertex end, StringBuffer buf) {
    buf.append('M');
  ...
  protected void meshToSAX(ContentHandler handler, Map svgContext, Polyline pline)
      throws SAXException {
    ...
    if (pline.isSimpleMesh()) {
      ...
      Point3D[][] points =
          new Point3D[pline.getSurefaceDensityRows()][pline.getSurefaceDensityColumns()];
  ...
  protected String getVertexPath(Vertex start, Vertex end, Polyline pline) {
    StringBuffer d = new StringBuffer();
