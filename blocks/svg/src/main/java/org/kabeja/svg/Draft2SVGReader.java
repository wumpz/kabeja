...
/**
 * This is a implementation of the SAX2 driver. You can parse DXF-Files as they are real
 * SVG-XML-Files.
 *
 * <p>Use:
 *
 ...
 */
public class Draft2SVGReader extends XMLFilterImpl {
  ...
  public void parse(InputSource input) throws IOException, SAXException {
    ...
    try {
      ...
      DraftDocument doc = this.parser.parse(input.getByteStream(), new HashMap());
  ...
  public void setProperty(String name, Object value)
    ...
    if (PROPERTY_DXF_ENCODING.equals(name)) {
      ...
      parser = DXFParserBuilder.buildFromXML(in);
    } else if (PROPERTY_PARSER_CONFIGURATION_FILENAME.equals(name)) {
      this.configURL = (String) value;
      parser = DXFParserBuilder.buildFromXML(this.configURL);
    }
  }

  protected void initialize() {
    if (this.parser == null) {
      this.parser = DXFParserBuilder.createDefaultParser();
    }
  ...
  public void startElement(String uri, String localName, String qName, Attributes atts)
    ...
    if (this.namespacesPrefix) {
      ...
      if (atts.getIndex("xmlns") == -1) {
        attributes.addAttribute("", "xmlns", "xmlns", "CDATA", SVGConstants.SVG_NAMESPACE);
      }

      if (atts.getIndex("xmlns:xlink") == -1) {
        attributes.addAttribute("", "", "xmlns:xlink", "CDATA", SVGConstants.XLINK_NAMESPACE);
      }
