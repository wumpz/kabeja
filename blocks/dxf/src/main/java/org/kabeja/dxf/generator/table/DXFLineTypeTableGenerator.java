...
public class DXFLineTypeTableGenerator implements DXFTableGenerator {
  ...
  protected void outputLinetypeEntry(LineType ltype, DXFProfile profile, DXFOutput output)
      throws GenerationException {
  ...
  protected void outputLinetypeEntry(LineType ltype, int groupCode, DXFOutput out)
      throws GenerationException {
    switch (groupCode) {
      case 0:
