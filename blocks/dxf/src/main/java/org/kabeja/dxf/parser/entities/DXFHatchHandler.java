    ...
    public void parseGroup(int groupCode, DXFValue value) throws ParseException {
        ...
        case GROUPCODE_BOUNDARY_EDGE_TYPE:
            ...
            if (!this.polylineBoundary) {
                ...
                case 3:
                    boundaryHandler = (DXFEntityHandler) boundaryHandlers.get(Constants.ENTITY_TYPE_ELLIPSE);
                    boundaryHandler.startDXFEntity();

                    break;

                case 4:
                    boundaryHandler = (DXFEntityHandler) boundaryHandlers.get(Constants.ENTITY_TYPE_SPLINE);
                    boundaryHandler.startDXFEntity();
