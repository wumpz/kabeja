...
public class SAXDXFParserBuilder implements ContentHandler {
    ...
    public void endElement(String namespaceURI, String localName, String qName)
        ...
        if (localName.equals(ELEMENT_HANDLERS) &&
            ...
            currentHandlerManager = (DXFHandlerManager) stack.pop();
        }
    }
    ...
    public void startElement(String namespaceURI, String localName,
        ...
        if (namespaceURI.equals(XMLNS_KABEJA_PARSER)) {
            if (localName.equals(ELEMENT_HANDLER)) {
                ...
                currentHandlerManager = (DXFHandlerManager) handler;
                ...
                try {
                    ...
                    if (this.parser instanceof DXFHandlerManager) {
                        this.currentHandlerManager = (DXFHandlerManager) this.parser;
                    }
    ...
    public static Parser buildFromStream(InputStream in) {
        SAXDXFParserBuilder builder = new SAXDXFParserBuilder();
