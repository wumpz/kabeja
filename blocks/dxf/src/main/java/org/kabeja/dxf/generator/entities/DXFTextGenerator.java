...
public class DXFTextGenerator extends AbstractDXFEntityGenerator {
  ...
  protected void outputGroupCode(int groupCode, DXFOutput out, DXFGenerationContext context)
        ...
        switch (groupCode) {
          ...
          case 40:
            if (text.getHeight() > 0) {
              ...
              output.output(
                  40, (String) context.getAttribute(DXFGenerationConstants.DEFAULT_TEXT_HEIGHT));
            }
            break;
          case 41:
