  ...
  public void output(int groupCode, int value) throws GenerationException {
    try {
      ...
      throw new GenerationException(
          "Error on groupCode:" + groupCode + " integer value:" + value, e);
    }
  }

  public void output(int groupCode, double value) throws GenerationException {
    try {
      this.outputGroupCode(groupCode);
      ...
      throw new GenerationException(
          "Error on groupCode:" + groupCode + " double value:" + value, e);
    }
  }

  public void output(int groupCode, String value) throws GenerationException {
    try {
      this.outputGroupCode(groupCode);
      ...
      throw new GenerationException(
          "Error on groupCode:" + groupCode + " string value:" + value, e);
    }
  }
