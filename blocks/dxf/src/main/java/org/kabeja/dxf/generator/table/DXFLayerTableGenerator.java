...
public class DXFLayerTableGenerator implements DXFTableGenerator {
  ...
  @Override
  public void output(
      DraftDocument doc, DXFOutput output, DXFGenerationContext dxfContext, DXFProfile type)
  ...
  protected void outputLayer(Layer layer, int groupCode, DXFOutput output)
      throws GenerationException {
    switch (groupCode) {
      case 0:
