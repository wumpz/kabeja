...
public class DXFViewportGenerator implements DXFTableGenerator {
  ...
  public void output(
      DraftDocument doc,
      DXFOutput out,
      org.kabeja.dxf.generator.DXFGenerationContext dxfContext,
      DXFProfile type)
      throws GenerationException {
    final int[] groupCodes =
        type.getDXFType(Constants.TABLE_KEY_VPORT).getDXFSubTypes().get(0).getGroupCodes();
