...
public class SAXInkscapeLayerFilter extends AbstractSAXFilter {
  ...
  public static final String INKSCAPE_NAMESPACE_PREFIX = "inkscape";
  public static final String INKSCAPE_ATTRIBUTE_GROUPMODE = "groupmode";
  public static final String INKSCAPE_ATTRIBUTE_GROUPMODE_VALUE = "layer";
  public static final String INKSCAPE_ATTRIBUTE_LABEL = "label";
  public static final String KABEJA_QNAME_LAYER_NAME =
      XMLConstants.KABEJA_NAMESPACE_PREFIX + ":" + XMLConstants.KABEJA_ATTRIBUTE_LAYER_NAME;
  protected int indent = 0;
  protected int mode = 0;

  public static final int MODE_DEFAULT = 0;
  public static final int MODE_DEF = 1;
  public static final int MODE_DRAFT_GROUP = 2;
    ...
    if (localName.equals(SVGConstants.SVG_GROUP) && this.mode != MODE_DEF) {
      ...
      if (indent == 2 && this.mode == MODE_DRAFT_GROUP) {
        attr = this.addInkscapeLayerAttributes(atts);
          ...
          && atts.getIndex(SVGConstants.XML_ID) > -1
  ...
  protected Attributes addInkscapeLayerAttributes(Attributes atts) {
    ...
    attr.addAttribute(
        ...
        INKSCAPE_NAMESPACE_PREFIX,
        "xmlns:" + INKSCAPE_NAMESPACE_PREFIX,
        "CDATA",
        INKSCAPE_NAMESPACE);
    attr.addAttribute(
        INKSCAPE_NAMESPACE,
        INKSCAPE_ATTRIBUTE_GROUPMODE,
        INKSCAPE_NAMESPACE_PREFIX + ':' + INKSCAPE_ATTRIBUTE_GROUPMODE,
        "CDATA",
        INKSCAPE_ATTRIBUTE_GROUPMODE_VALUE);
    attr.addAttribute(
        INKSCAPE_NAMESPACE,
        INKSCAPE_ATTRIBUTE_LABEL,
        INKSCAPE_NAMESPACE_PREFIX + ':' + INKSCAPE_ATTRIBUTE_LABEL,
        "CDATA",
        atts.getValue(KABEJA_QNAME_LAYER_NAME));
